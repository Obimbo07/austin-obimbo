...
export const experience = [
  {
    ...
    workLocation: 'Remote',
    workOrganisation: 'Personal',
    workLogo: 'logo-shine.png',
  ...
  },
  {
    ...
    workLocation: 'Remote',
    workOrganisation: 'Digital Tailor Agency',
    workLogo: '635932f5ec4ad49c672d31c7_logo_dta.svg',
    description: "I worked remotely developing 3+ software solutions using technologies such as Python, Django, Ruby on Rails, and React (Nextjs). I was also taught how to manage cloud infrastructure and deploy applications in production. I handled the data pipeline and integrated CI/CD. I helped monitor deployed software systems remotely and gave timely feedback to my managers. I mastered good communication skills, managing company projects using agile methodologies and behavior-driven development. I helped hold meetings with clients and understand the software requirements helping define quality attributes.",
  ...
  },
  {
    ...
    workOrganisation: 'Tech To the Rescue',
    workLogo: 'TechToTheResacue-logo-horizontal.svg',
    description: 'Developed a USSD based surplus food distribution system for habanahaba food bank. I collaborated with a team of 3 members me inclusive. I was able to develop the ussd algorithm to handle requests in less than 10 seconds. This algorithm supported multi-lingual support including english and Luganda. I intergarted data analysis algorithm into the system to help provide insights from food requests and food donations ',
...
export const achievements = [
  ...
  {
    index: 0,
    title: 'Davis and Shirtliff 2024 Hackathon Innovate with AI, IoT and More ',
    date: '29th July - 29 August 2024',
    description: 'Won the hackathon in teams of two projects. An Ai product quotation and sizing system and a Technician microservice mobile app. Collaborated remotely and helped contribute to project progress through online meetings. Understood how microservice architecture works and grew knowlegde on developing and training  LLMs for retrival augumented generation(RAG) sytems.',
  },
