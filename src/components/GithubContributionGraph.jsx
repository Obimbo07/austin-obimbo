...
const GitHubContributionGraph = () => {
  ...
  return (
    <div className="flex flex-col items-center px-8 my-2 text-black  font-semibold bg-white rounded-3xl">
     ...
     <h1 className='font-extrabold text-4xl text-center w-fit p-2 font-mono antialiased outline'>Github contibution calendar</h1>
      <div className="my-8">
        ...
        <button
          className="bg-orange-500 text-white p-2 rounded-full ml-2"
