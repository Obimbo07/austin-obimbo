...
const AboutText = () => {
  return (
    <>
      <div className="flex flex-col md:flex-row text-white text-overflow ">
            <Avatar className='rounded-full w-40 h-auto w-full md:w-1/5 lg:w-1/5 h-fit'>
         ...
         <div className="p-8">
          ...
          <p className="text-base sm:text-lg md:text-xl text-start md:text-center mb-4 bg-orange-500 p-8 rounded-3xl">
            I am currently working as a Full-stack software developer at <a className="text-blue-500" href="">Tech to the Rescue</a>. I help ship features faster and create scalable algorithms to help improve product output. I use data analysis and operations to help improve
          </p>
