    ...
    <div className="bg-[#f8f2f0] bg-gray-400 min-h-screen p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full max-w-6xl mx-auto">
        ...
        <div>
            ...
            <div className="flex flex-none w-full flex-row md:flex-row justify-center items-start gap-4 py-4">
                <div className="flex flex-none flex-col w-1/2 justify-center items-start gap-4 p-8 rounded-3xl bg-white shadow-lg">
                  <Quote />
                  <span className="text-end w-full">Autogenerated quotes</span>
                </div>
                <Link to="/technologies" className="flex flex-grow toolbox hover:opacity-100 opacity-70 w-1/2 h-fit flex-col justify-center items-start gap-4 p-12 rounded-3xl shadow-lg outline outline-1  outline-offset-2 outline-neutral-100">
